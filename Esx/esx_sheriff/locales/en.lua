Locales['en'] = {
  ...
  ['armory'] = 'Sheriff\'s Locker',
  ['open_armory'] = 'press ~INPUT_CONTEXT~ to access the Sheriff\'s Locker',
  -- Vehicles
  ['vehicle_menu'] = 'Sheriff\'s Vehicle\'s',
